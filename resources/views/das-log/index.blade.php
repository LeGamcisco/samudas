    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="#" id="form-filter" class="row" method="get">
          ...
          <div class="form-group col-md-6">
            <label class="form-label fw-bold">Status Sending DIS</label>
...
<script>
  $(document).ready(function(){
    const table = $('#table-data').DataTable({
      ...
      columns: [
        ...
        },
        {
          data : 'is_sent',
          render : function(data,type,row){
            return `${row.is_sent == 1 ? `<span class="badge bg-success">Sent</span>` : `<span class="badge bg-danger">Not Sent</span>`}`
          }
        },
      ]
    })
    ...
    $("#btn-export").click(function(){
       ...
       window.location.href = `{{ route('das-logs.export') }}?${params}`
    })
  })
</script>
@endsection